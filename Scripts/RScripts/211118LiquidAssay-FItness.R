...
#P78048 -A4
A04POS <- subset(LA_POSm, strain == "A04")
A04POS_anc_24 <- mean(subset(LA_POSm, strain == "A04" & time ==0)$OD24)
A04POS_anc_72 <- mean(subset(LA_POSm, strain == "A04" & time ==0)$OD72)
A04POS_evol_24_diff <- subset(LA_POSm, strain == "A04" & time ==5)$OD24 - A04POS_anc_24
A04POS_evol_72_diff <- subset(LA_POSm, strain == "A04" & time ==5)$OD72 - A04POS_anc_72
A04YPD <- subset(LA_YPDm, strain == "A04")
A04YPD_anc_24 <- mean(subset(LA_YPDm, strain == "A04" & time ==0)$OD24)
A04YPD_anc_72 <- mean(subset(LA_YPDm, strain == "A04" & time ==0)$OD72)
A04YPD_evol_24_diff <- subset(LA_YPDm, strain == "A04" & time ==5)$OD24 - A04YPD_anc_24
A04YPD_evol_72_diff <- subset(LA_YPDm, strain == "A04" & time ==5)$OD72 - A04YPD_anc_72

plot(A04POS_evol_72_diff, A04YPD_evol_72_diff)
t24_A04 <- cor.test(A04POS_evol_24_diff, A04YPD_evol_24_diff)
t72_A04 <- cor.test(A04POS_evol_72_diff, A04YPD_evol_72_diff)

#A17 - SC5314
A17POS <- subset(LA_POSm, strain == "A17")
A17POS_anc_24 <- mean(subset(LA_POSm, strain == "A17" & time ==0)$OD24)
A17POS_anc_72 <- mean(subset(LA_POSm, strain == "A17" & time ==0)$OD72)
A17POS_evol_24_diff <- subset(LA_POSm, strain == "A17" & time ==5)$OD24 - A17POS_anc_24
A17POS_evol_72_diff <- subset(LA_POSm, strain == "A17" & time ==5)$OD72 - A17POS_anc_72
A17YPD <- subset(LA_YPDm, strain == "A17")
A17YPD_anc_24 <- mean(subset(LA_YPDm, strain == "A17" & time ==0)$OD24)
A17YPD_anc_72 <- mean(subset(LA_YPDm, strain == "A17" & time ==0)$OD72)
A17YPD_evol_24_diff <- subset(LA_YPDm, strain == "A17" & time ==5)$OD24 - A17YPD_anc_24
A17YPD_evol_72_diff <- subset(LA_YPDm, strain == "A17" & time ==5)$OD72 - A17YPD_anc_72

plot(A17POS_evol_72_diff, A17YPD_evol_72_diff)
t24_A17 <- cor.test(A17POS_evol_24_diff, A17YPD_evol_24_diff)
t72_A17 <- cor.test(A17POS_evol_72_diff, A17YPD_evol_72_diff)

#FH1
A18POS <- subset(LA_POSm, strain == "A18")
A18POS_anc_24 <- mean(subset(LA_POSm, strain == "A18" & time ==0)$OD24)
A18POS_anc_72 <- mean(subset(LA_POSm, strain == "A18" & time ==0)$OD72)
A18POS_evol_24_diff <- subset(LA_POSm, strain == "A18" & time ==5)$OD24 - A18POS_anc_24
A18POS_evol_72_diff <- subset(LA_POSm, strain == "A18" & time ==5)$OD72 - A18POS_anc_72
A18YPD <- subset(LA_YPDm, strain == "A18")
A18YPD_anc_24 <- mean(subset(LA_YPDm, strain == "A18" & time ==0)$OD24)
A18YPD_anc_72 <- mean(subset(LA_YPDm, strain == "A18" & time ==0)$OD72)
A18YPD_evol_24_diff <- subset(LA_YPDm, strain == "A18" & time ==5)$OD24 - A18YPD_anc_24
A18YPD_evol_72_diff <- subset(LA_YPDm, strain == "A18" & time ==5)$OD72 - A18YPD_anc_72

plot(A18POS_evol_72_diff, A18YPD_evol_72_diff)
t24_A18 <- cor.test(A18POS_evol_24_diff, A18YPD_evol_24_diff)
t72_A18 <- cor.test(A18POS_evol_72_diff, A18YPD_evol_72_diff)

#P76055 - A10
A10POS <- subset(LA_POSm, strain == "A10")
A10POS_anc_24 <- mean(subset(LA_POSm, strain == "A10" & time ==0)$OD24)
A10POS_anc_72 <- mean(subset(LA_POSm, strain == "A10" & time ==0)$OD72)
A10POS_evol_24_diff <- subset(LA_POSm, strain == "A10" & time ==5)$OD24 - A10POS_anc_24
A10POS_evol_72_diff <- subset(LA_POSm, strain == "A10" & time ==5)$OD72 - A10POS_anc_72
A10YPD <- subset(LA_YPDm, strain == "A10")
A10YPD_anc_24 <- mean(subset(LA_YPDm, strain == "A10" & time ==0)$OD24)
A10YPD_anc_72 <- mean(subset(LA_YPDm, strain == "A10" & time ==0)$OD72)
A10YPD_evol_24_diff <- subset(LA_YPDm, strain == "A10" & time ==5)$OD24 - A10YPD_anc_24
A10YPD_evol_72_diff <- subset(LA_YPDm, strain == "A10" & time ==5)$OD72 - A10YPD_anc_72

plot(A10POS_evol_72_diff, A10YPD_evol_72_diff)
t24_A10 <- cor.test(A10POS_evol_24_diff, A10YPD_evol_24_diff)
t72_A10 <- cor.test(A10POS_evol_72_diff, A10YPD_evol_72_diff)

#T101 -A12
A12POS <- subset(LA_POSm, strain == "A12")
A12POS_anc_24 <- mean(subset(LA_POSm, strain == "A12" & time ==0)$OD24)
A12POS_anc_72 <- mean(subset(LA_POSm, strain == "A12" & time ==0)$OD72)
A12POS_evol_24_diff <- subset(LA_POSm, strain == "A12" & time ==5)$OD24 - A12POS_anc_24
A12POS_evol_72_diff <- subset(LA_POSm, strain == "A12" & time ==5)$OD72 - A12POS_anc_72
A12YPD <- subset(LA_YPDm, strain == "A12")
A12YPD_anc_24 <- mean(subset(LA_YPDm, strain == "A12" & time ==0)$OD24)
A12YPD_anc_72 <- mean(subset(LA_YPDm, strain == "A12" & time ==0)$OD72)
A12YPD_evol_24_diff <- subset(LA_YPDm, strain == "A12" & time ==5)$OD24 - A12YPD_anc_24
A12YPD_evol_72_diff <- subset(LA_YPDm, strain == "A12" & time ==5)$OD72 - A12YPD_anc_72

plot(A12POS_evol_72_diff, A12YPD_evol_72_diff)
t24_A12 <- cor.test(A12POS_evol_24_diff, A12YPD_evol_24_diff)
t72_A12 <- cor.test(A12POS_evol_72_diff, A12YPD_evol_72_diff)
